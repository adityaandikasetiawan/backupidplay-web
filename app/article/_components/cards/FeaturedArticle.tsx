  ...
  return (
    <div className="mb-16">
      <Link href={`/article/${article.slug}`} className="block">
        <div className="bg-white rounded-2xl overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 py-4 md:px-10 md:py-10 flex flex-col justify-center">
              ...
              {/* Title */}
              <h3 className="text-2xl md:text-4xl font-bold text-orange-500 mb-2 group-hover:underline line-clamp-2">
                {article.title}
              </h3>
